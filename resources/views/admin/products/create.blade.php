...
@section('title', 'Tambah Produk - CV. Tri Jaya')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required
                            placeholder="Contoh: Terpal A3, Terpal Korea, dll"
                    ...
                    <div>
                        <label for="price_per_m2" class="block text-sm font-medium text-gray-700 mb-1">Harga per m²
                            (Rupiah)</label>
                        <input type="number" id="price_per_m2" name="price_per_m2" value="{{ old('price_per_m2') }}"
                            required min="0" step="100" placeholder="Contoh: 25000"
                    ...
                    <div>
                        <label for="weight_per_m2" class="block text-sm font-medium text-gray-700 mb-1">Berat per m²
                            (kg)</label>
                        <input type="number" id="weight_per_m2" name="weight_per_m2" value="{{ old('weight_per_m2') }}"
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Deskripsi produk terpal..."
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Format: JPEG, PNG, WebP. Maks: 2MB.</p>
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Tambahkan roll terpal beserta ukuran panjang x lebar (meter).</p>
                    </div>
                ...
                <div id="rollsContainer" class="space-y-3">
                    ...
                    <div class="roll-row flex items-center gap-3">
                        <div class="flex-1">
                            ...
                            <input type="number" name="rolls[0][length]" value="{{ old('rolls.0.length') }}" required
                                min="0.01" step="0.01" placeholder="Panjang"
                        ...
                        <div class="flex-1">
                            ...
                            <input type="number" name="rolls[0][width]" value="{{ old('rolls.0.width') }}" required
                                min="0.01" step="0.01" placeholder="Lebar"
